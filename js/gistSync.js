...
const GistSync = {
    KEYS: {
        TOKEN: (window.SJ_SCOPE || 'sj') + '_gist_token',
        GIST_ID: (window.SJ_SCOPE || 'sj') + '_gist_id',
        LAST_SYNC: (window.SJ_SCOPE || 'sj') + '_gist_last_sync',
        LAST_LOCAL: (window.SJ_SCOPE || 'sj') + '_gist_last_local'
    },
